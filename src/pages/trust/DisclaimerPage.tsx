...
export function DisclaimerPage() {
  return (
    <TrustPage
      ...
      metaDescription="GroundFloor is not a broker, adviser, or fiduciary. Nothing on this site is investment advice, a recommendation, or an offer of securities."
    ...
    >
      ...
      <ul className="disclaimer-list">
        <li><b>GroundFloor is not a broker, dealer, investment adviser, analyst, or fiduciary.</b> We are a platform for coordinating shareholder questions — nothing more.</li>
        ...
        <li><b>GroundFloor does not verify all user statements.</b> Shareholder status is self-reported; user-submitted content may be wrong.</li>
